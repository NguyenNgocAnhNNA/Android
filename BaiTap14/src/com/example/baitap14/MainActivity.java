...
public class MainActivity extends Activity {
    ...
    //hàm xử lý nhập thông tin nhân viên
    public void xulyNhap()
    {
    	String ma = editMa.getText() + "";
    	String ten = editTen.getText() + "";
    	boolean gioitinh = false; //false = nam
    	...
    	//gọi hàm cập nhậ giao diện
    	adapter.notifyDataSetChanged();
    	
    	//sau khi update thì xóa trắng dữ liệu và cho editma foucus
    	editMa.setText("");
    	editTen.setText("");
    	editMa.requestFocus();
    }
    ...
    public void xulyXoa()
    {
    	...
    	for(int i = lvNhanvien.getChildCount() - 1; i >= 0; i--){
    		...
    		//sau khi xóa thì gọi update giao diện
    		adapter.notifyDataSetChanged();
    	}
    }
