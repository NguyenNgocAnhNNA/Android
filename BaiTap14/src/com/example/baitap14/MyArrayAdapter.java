...
public class MyArrayAdapter extends ArrayAdapter<Employee> {
	 ...
	 * context : là Activity từ Main
	 * layoutId: Là layout custom do mình tạo (my_item_layout.xml)
	 * arr : Danh sách nhân viên truyền từ Main
	 */
	 ...
	 * position : là vị trí của phần tử trong danh sách nhân viên
	 * convertView: convertView, dùng nó để xử lý Item
	 * parent : Danh sách nhân viên truyền từ Main
	 * View: trả về chính convertView
	 */
	
	public View getView(int position, View convertView, ViewGroup parent) {
	 /**
	 * chú ý là ở đây không làm:
	 * if(convertView==null)
	 * {
	 ...
	 */
	 ...
	 if(myArray.size()>0 && position>=0)
	 {
		 ...
		 return convertView;
		 //trả về View này, tức là trả luôn
